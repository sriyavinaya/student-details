    ...
    <div className="flex flex-col min-h-screen">
      ...
      <header className="bg-gray-200 p-4 flex justify-between items-center">
        <div className="flex items-center space-x-2">
          ...
          <h1 className="text-xl font-medium">StudentDetails</h1>
        </div>
        <Link 
          to="/login" 
      ...
      <main className="flex-1 flex flex-col md:flex-row items-center justify-center p-6 bg-blue-50">
        <div className="md:w-1/2 max-w-2xl p-8 bg-blue-100 rounded-3xl mb-8 md:mb-0 md:mr-8">
          ...
          <p className="text-gray-800 text-center leading-relaxed">
            At StudentDetails, we simplify the way institutions manage and
      ...
      <footer className="bg-gray-200 p-4 text-center text-gray-600">
        <p>© 2025 StudentDetails. All rights reserved.</p>
      </footer>
    </div>
  );
};
