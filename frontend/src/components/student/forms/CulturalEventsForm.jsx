...
const CulturalEventsForm = ({ event, onClose, onSave, refreshTable }) => {
    ...
    const uploadProofDocument = async () => {
        ...
        fileData.append('file', formData.documentPath);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(
                'http://localhost:8080/api/cultural/submit', // Changed to cultural endpoint
                formDataToSend,
                { 
                    withCredentials: true,
                    headers: {
            ...
            <form onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 gap-4">
                    <label className="block">
                        <span className="text-gray-700"><span className="text-red-500">*</span> Event Name</span>
                        <input
                            type="text"
                            name="title"
                    ...
                    <label className="block">
                        <span className="text-gray-700"><span className="text-red-500">*</span> Host</span>
                        <input
                            type="text"
                            name="host"
                            value={formData.host}
                    ...
                    <label className="block">
                        <span className="text-gray-700"><span className="text-red-500">*</span> Category</span>
                        <select
                            name="category"
                    ...
                    <label className="block">
                        <span className="text-gray-700"><span className="text-red-500">*</span> Date</span>
                        <input
                            type="date"
                            name="eventDate"
                    ...
                    <label className="block">
                        <span className="text-gray-700"><span className="text-red-500">*</span> Achievement</span>
                        <input
                            type="text"
                            name="achievement"
                    ...
                    <label className="block">
                        <span className="text-gray-700"><span className="text-red-500">* </span> Proof Document</span>
